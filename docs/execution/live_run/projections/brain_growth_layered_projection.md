...
- hidden_8_to_hidden_9: 12
- hidden_9_to_hidden_10: 12
- hidden_10_to_hidden_11: 4
- index_to_index: 8
...
- hidden_10: node_count=4, internal_edges=0, external_edges=16, layers=hidden_10=4
- hidden_11: node_count=4, internal_edges=0, external_edges=4, layers=hidden_11=4
- hidden_8: node_count=4, internal_edges=0, external_edges=15, layers=hidden_8=4
- hidden_9: node_count=4, internal_edges=0, external_edges=24, layers=hidden_9=4
...
- hidden_11: cluster_count=1, dominant_cluster=hidden_11, dominant_cluster_share=1.0
...
- [[H8_Dominant_Thoughtseed_Selection]] (domain=hidden_8, incoming=2, outgoing=3, layer_column=6, slot_index=1, x=1440, y=-80)
- [[H8_Exception_Override_Arbitration]] (domain=hidden_8, incoming=0, outgoing=3, layer_column=6, slot_index=2, x=1440, y=80)
- [[H8_Global_Policy_Broadcast]] (domain=hidden_8, incoming=0, outgoing=3, layer_column=6, slot_index=3, x=1440, y=240)

### hidden_9

- [[H9_Commit_Ready_Delivery_Check]] (domain=hidden_9, incoming=4, outgoing=3, layer_column=7, slot_index=0, x=1680, y=-240)
- [[H9_Execution_Surface_Binding]] (domain=hidden_9, incoming=4, outgoing=3, layer_column=7, slot_index=1, x=1680, y=-80)
- [[H9_Failsafe_Action_Packaging]] (domain=hidden_9, incoming=1, outgoing=3, layer_column=7, slot_index=2, x=1680, y=80)
- [[H9_Response_Payload_Composition]] (domain=hidden_9, incoming=3, outgoing=3, layer_column=7, slot_index=3, x=1680, y=240)

### hidden_10

- [[H10_Global_Supervision_Arbitration]] (domain=hidden_10, incoming=4, outgoing=1, layer_column=8, slot_index=0, x=1920, y=-240)
- [[H10_Long_Horizon_Outcome_Review]] (domain=hidden_10, incoming=2, outgoing=1, layer_column=8, slot_index=1, x=1920, y=-80)
- [[H10_Rollback_Escalation_Governance]] (domain=hidden_10, incoming=3, outgoing=1, layer_column=8, slot_index=2, x=1920, y=80)
- [[H10_Strategic_Resource_Oversight]] (domain=hidden_10, incoming=3, outgoing=1, layer_column=8, slot_index=3, x=1920, y=240)

### hidden_11

- [[H11_Failsafe_Cost_Accounting]] (domain=hidden_11, incoming=1, outgoing=0, layer_column=9, slot_index=0, x=2160, y=-240)
- [[H11_Outcome_Regression_Postmortem]] (domain=hidden_11, incoming=1, outgoing=0, layer_column=9, slot_index=1, x=2160, y=-80)
- [[H11_Rollback_Decision_Audit]] (domain=hidden_11, incoming=1, outgoing=0, layer_column=9, slot_index=2, x=2160, y=80)
- [[H11_Trace_Provenance_Attestation]] (domain=hidden_11, incoming=1, outgoing=0, layer_column=9, slot_index=3, x=2160, y=240)

### index

- [[Index_Apple_Silicon_and_MLX]] (domain=domain/apple_silicon_mlx, incoming=10, outgoing=1, layer_column=10, slot_index=0, x=2400, y=-320)
- [[Index_Cognitive_Graph_RAG]] (domain=domain/cognitive_graph_rag_routing, incoming=10, outgoing=1, layer_column=10, slot_index=1, x=2400, y=-160)
- [[Index_Cryptography_and_Memory_Safety]] (domain=domain/cryptographic_integrity_memory_safety, incoming=10, outgoing=1, layer_column=10, slot_index=2, x=2400, y=0)
- [[Index_Embedded_and_ESP32]] (domain=domain/embedded_interrupt_dma, incoming=10, outgoing=1, layer_column=10, slot_index=3, x=2400, y=160)
- [[Brain_Growth_Index]] (domain=navigation/domain_entry, incoming=8, outgoing=4, layer_column=10, slot_index=4, x=2400, y=320)
